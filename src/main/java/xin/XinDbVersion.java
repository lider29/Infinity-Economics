 ...
 ******************************************************************************/
  ...
  class XinDbVersion extends DbVersion {
      ...
      protected void update(int nextUpdate) {
          switch (nextUpdate) {
              ...
              case 78:
                  apply("CREATE INDEX IF NOT EXISTS alias_offer_buyer_id_idx ON alias_offer(buyer_id) ");
              case 79:
              ...
              case 138:
                  apply("CREATE TABLE IF NOT EXISTS currency (db_id IDENTITY, id BIGINT NOT NULL, account_id BIGINT NOT NULL, "
                          ...
                          + "min_reserve_per_unit_tqt BIGINT NOT NULL, min_difficulty TINYINT NOT NULL, "
              ...
              case 193:
                  apply("CREATE TABLE IF NOT EXISTS currency_supply (db_id IDENTITY, id BIGINT NOT NULL, "
                          + "current_supply BIGINT NOT NULL, current_reserve_per_unit_tqt BIGINT NOT NULL, height INT NOT NULL, "
                          + "latest BOOLEAN NOT NULL DEFAULT TRUE)");
              case 194:
              ...
              case 197:
                  apply("ALTER TABLE currency DROP COLUMN IF EXISTS current_reserve_per_unit_tqt");
              case 198:
                  apply(null);
              case 199:
                  apply(null);
              ...
              case 515:
                  apply(null);
              case 516:
                  apply(null); // apply("ALTER TABLE block ADD COLUMN IF NOT EXISTS ats BINARY");
              case 517:
                  return;
              default:
