...
public class AccountLedger {
     ...
     */
    public static final int trimKeep = Xin.getIntProperty("xin.ledgerTrimKeep", 30000);

    /**
     * Blockchain
     */
    private static final Blockchain blockchain = Xin.getBlockchain();

    /**
     * Blockchain processor
     */
    private static final BlockchainProcessor blockchainProcessor = Xin.getBlockchainProcessor();
     ...
     */
    static {
        List<String> ledgerAccounts = Xin.getStringListProperty("xin.ledgerAccounts");
        ...
        int temp = Xin.getIntProperty("xin.ledgerLogUnconfirmed", 1);
     ...
     * Initialization
     * <p>
     * We don't do anything but we need to be called from xin.init() in order to
     * register our table
     */
    static void init() {
    }
    ...
    public enum LedgerHolding {
        UNCONFIRMED_XIN_BALANCE(1, true),
        XIN_BALANCE(2, false),
