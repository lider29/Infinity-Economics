...
public final class Constants {
    ...
    public static final int MAX_DIVIDEND_PER_BLOCKS = 43200;
    public static final int MAX_ACCOUNTS_FOR_DIVIDEND_PAYMENT = 5000;
    ...
    public static final int HUB_ANNOUNCEMENT_BLOCK = Integer.MAX_VALUE;

    public static final int TQT_BLOCK = 1;
    public static final int NON_GENESIS_BLOCK_START_HEIGHT = 1;

    public static final int REFERENCED_TRANSACTION_FULL_HASH_BLOCK = 0;
    public static final int PHASING_BLOCK = 1;
    public static final int SHUFFLING_BLOCK = 1; // Integer.MAX_VALUE;
    public static final int DIVIDEND_THROTTLE_BLOCK = 1;

    public static final int LAST_CHECKSUM_BLOCK = -1;
    public static final int LAST_KNOWN_BLOCK = 100000;   // 0
    ...
    public static final boolean ALLOW_DUPLICATE_CURRENCY_CODE = false;
    ...
    public static final long ESCROW_START_BLOCK = Integer.MAX_VALUE;
    public static final int ESCROW_MAX_NUM_OF_SIGNERS = 10;
    public static final int ESCROW_MIN_NUM_OF_SIGNERS = 1;

    public static final long SUBSCRIPTION_START_BLOCK = Integer.MAX_VALUE;
    public static final int SUBSCRIPTION_MIN_FREQ = 3600;
    public static final int SUBSCRIPTION_MAX_FREQ = 31536000;
    ...
    protected static final int AUTOMATED_TRANSACTION_BLOCK = Integer.MAX_VALUE;
