...
public final class GetBlockchainTransactions extends APIServlet.APIRequestHandler {
    ...
    // Check for first / last. If last < first it shows all !!
    ...
    protected JSONStreamAware processRequest(HttpServletRequest req) throws XinException {
        ...
        try (DbIterator<? extends Transaction> iterator = Xin.getBlockchain().getTransactions(accountId, numberOfConfirmations,
