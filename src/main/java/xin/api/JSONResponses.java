...
public final class JSONResponses {
    ...
    public static final JSONStreamAware INCORRECT_ADMIN_PASSWORD = incorrect("adminPassword", "(the specified password does not match xin.adminPassword)");
    ...
    static {
        ...
        response.put("errorDescription", "Account is not generating blocks");
    ...
    static {
        JSONObject response = new JSONObject();
        response.put("errorCode", 8);
        response.put("errorDescription", "Administrator's password is not configured. Please set xin.adminPassword");
    ...
    static {
        JSONObject response = new JSONObject();
        response.put("errorCode", 8);
        response.put("errorDescription", "Poll results no longer available, set xin.processPolls=true and rescan");
