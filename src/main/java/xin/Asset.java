...
public final class Asset {
    ...
    public static DbIterator<Asset> getAllAssets(int from, int to, SortClause sortClause) {
        return assetTable.getAll(from, to,sortClause.getClause());
    }
    ...
    public static boolean isAssetNameTaken(String name) {
        int count = assetTable.getCount(new DbClause.StringClause("lower(name)", name.toLowerCase()));
        return count!=0;
    }
