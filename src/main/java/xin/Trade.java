...
public final class Trade {
    ...
    private Trade(long assetId, Order.Ask askOrder, Order.Bid bidOrder) {
        Block block = Xin.getBlockchain().getLastBlock();
        ...
        this.priceTQT = isBuy ? askOrder.getPriceTQT() : bidOrder.getPriceTQT();
    }
    ...
    public String toString() {
        return "Trade asset: " + Long.toUnsignedString(assetId) + " ask: " + Long.toUnsignedString(askOrderId)
                + " bid: " + Long.toUnsignedString(bidOrderId) + " price: " + priceTQT + " quantity: " + quantityQNT + " height: " + height;
    }
